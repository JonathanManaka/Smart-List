...
```
cd existing_repo
git remote add origin https://gitlab.com/JonathanManaka/smart-grocery-list.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/JonathanManaka/smart-grocery-list/-/settings/integrations)
